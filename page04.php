...
<!-- post content -->
 <div class="post-header">
  <div class="header-content post-container">
      ...
      <br>
      <br>
      <h1 class="header-title">Javanese shadow puppets exhibited at the Asian Art Museum in the United States</h1>
      <br>
      <br>
      <img src="img/all/kulit.hr.png" alt="header-img">
...
<!-- pootsts -->
 <section class="post-content post-container">
  ...
  <p class="post-text">
    <h2>Yogyakarta, Indonesia – July 21, 2024</h2>
    Javanese Wayang Kulit crafts have gained international attention with their exhibition at the Asian Art Museum in the United States. The exhibition titled "Shadow Puppets: The Art of Javanese Wayang Kulit" showcases various collections of Wayang Kulit from Java, providing Americans with an opportunity to explore Indonesia's rich and diverse cultural heritage.
    ...
    The success of the exhibition is attributed to the support from the Indonesian government and various cultural institutions. The Ministry of Tourism and Creative Economy, along with the Indonesian Embassy in the United States, played a crucial role in coordinating the exhibition. Additionally, several cultural institutions in Indonesia, such as the Sonobudoyo Museum in Yogyakarta, lent their collections for display.
    <h2>Awards and Recognition</h2>
    The "Shadow Puppets: The Art of Javanese Wayang Kulit" exhibition has also received accolades from various quarters, including art critics and academics. They praised the cultural preservation efforts carried out through the exhibition and the opportunity provided for Americans to learn about and appreciate traditional Indonesian art.
    <h2>Future Hopes</h2>
    Through this exhibition, it is hoped that more people around the world will come to know and appreciate Javanese Wayang Kulit. The exhibition also aims to inspire the younger generation in Indonesia to continue preserving and developing this traditional art form. With ongoing support, Wayang Kulit will remain an important part of Indonesia's cultural heritage and gain recognition on the international stage.
</p>    
 </section>
